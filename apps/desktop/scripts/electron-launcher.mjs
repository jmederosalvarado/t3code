// This file mostly exists because we want dev mode to say "T3 Code JM (Dev)" instead of "electron"
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "T3 Code JM (Dev)" : "T3 Code JM";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.jmederosalvarado.t3code.dev.${devBundleIdSuffix || "local"}`
  : "com.jmederosalvarado.t3code";
